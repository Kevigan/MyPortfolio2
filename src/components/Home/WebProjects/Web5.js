        ...
        <div className="game-content">
            ...
            <div className='game-image-container'>
                <div className='image-grid'>
                    <img src={API_1} className={expanded1 ? 'expanded' : 'normal'} alt="finger infornt of mouth" onClick={() => toggleExpand(1)} />
                    <img src={API_2} className={expanded2 ? 'expanded' : 'normal'} alt="finger infornt of mouth" onClick={() => toggleExpand(2)} />
                    <img src={API_3} className={expanded3 ? 'expanded' : 'normal'} alt="Code 1" onClick={() => toggleExpand(3)} />
                    <img src={API_4} className={expanded4 ? 'expanded' : 'normal'} alt="Code 2" onClick={() => toggleExpand(4)} />
                </div>
